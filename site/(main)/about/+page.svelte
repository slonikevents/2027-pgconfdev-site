...
<figure class="section">
  <enhanced:img
    class="screen"
    src="./hero.jpeg"
    alt="A packed auditorium, nearly every seat taken, facing a panel of eight seated on stage"
    sizes="100vw"
    fetchpriority="high"
  />

  <figcaption class="main over" style:text-align="center">
    <strong>2026 · Vancouver</strong> The 30 Years of PostgreSQL Retrospective
  </figcaption>
</figure>

<section aria-label="Statistics">
  <div class="(main) grid+8 margin-gap">
    <figure>
...
<section id="what" class="*:main">
  ...
  <figure class="(main section">
    <blockquote class="action-acme h2 mute" style:text-wrap="revert">
      <q>
